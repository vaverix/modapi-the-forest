...
{
    public class CheatMenuPlusComponent : MonoBehaviour
    {
        protected bool visible = false;
        public static bool GodMode = false;
        public static bool HeavyMode = false;
        ...
        static void AddMeToScene() 
        {
            ...
            GO.AddComponent<CheatMenuPlusComponent>();
        }
        ...
        private void OnGUI()
        {
            if (this.visible)
            {
                ...
                GUI.Label(new Rect(20f, cY, 150f, 20f), "Heavy mode:", labelStyle);
                HeavyMode = GUI.Toggle(new Rect(170f, cY, 20f, 30f), HeavyMode, "");
                cY += 30f;
